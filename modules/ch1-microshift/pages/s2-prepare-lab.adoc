...
Prepare a test environment for building bootc containers including MicroShift.
...
You now have your _development machine_ ready to build bootc containers, and your _web server machine_ ready to store and distribute files for your edge devices. 
