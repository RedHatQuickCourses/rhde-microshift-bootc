...
Prepare a test environment for air-gaped deployment of MicroShift in both package and image modes of RHEL.
...
You now have your _mirror registry machine_ and your _package server machine_ ready to support the air-gaped deployment of MicroShift in both package and image modes of RHEL.
